...
define('_MD_FORMMAKEX_DETAIL', 'Detail');
...
define('_MD_FORMMAKEX_THANKS_ENTRY', 'Thank You For Completing This Form!');
define('_MD_FORMMAKEX_CAN_WRITE_USER_ONLY', 'Guest cannot edit form!');
define('_MD_FORMMAKEX_YOU_DONT_HAVE_A_PERMISSION', 'You don\'t have a permission.');
define('_MD_ASTERISK_REQUIRED', 'Questions marked with a <font color="#FF0000">*</font> are required.');
define('_MD_MAIL_TITLE', 'Response from FORMMAKEX:');
...
define('_MD_FORMMAKEX_FORMATERR', ' is not correctly input.');
define('_MD_FORMMAKEX_DIGITERR', ' is not digit.');
define('_MD_FORMMAKEX_MAXOVER', ' may not accept over %u.');
define('_MD_FORMMAKEX_CHECKANY', '(Check any)');
define('_MD_FORMMAKEX_CHECKLIMIT', '(Check until %u)');
define('_MD_FORMMAKEX_CHECKRESET', 'Reset');
define('_MD_SUBMIT_FORM', 'Submit Form');
define('_MD_NEXT_PAGE', 'Next Page');
define('_MD_FORMMAKEX_COPY_TITLE_PREFIX', 'Copy %s~ ');
...
define('_AM_FORMMAKEX_PURGE','Purge');
...
define("_MB_Your_progress_has_been_saved","Your progress has been saved.  You may return at any time to complete this form.  To do so, simply bookmark the link below.  You may be prompted for your username and password to complete the form.");
...
define("_MB_Username_are_required","Username, Password, and Group are required.");
...
define("_MB_Click_on_a_username_to_edit","Click on a username to edit, or click on add new user below.");
define("_MB_disabled","disabled");
...
define("_MB_Request_failed","Request failed, please choose a different username.");
