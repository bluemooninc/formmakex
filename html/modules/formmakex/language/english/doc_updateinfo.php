...
<h3>1. Backup formmakex_form table</h3>
<p>Backup a formmakex_form table. ('xoops_' is XOOPS prefix.) 
...
<p>&nbsp;&nbsp;  Copy all structure from formmakex_respondent table on formmakex/sql/mysql.sql and replace it.
<p><li> Find a bmef_form table and add one line after email.
<p>&nbsp;&nbsp;  from_option TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL,
<p><li> Rename all tables name 'bmef_' to 'formmakex_'
<p><li> save it. 
<h3>3. Restore a backup file</h3>
<p>Restore an edited backup file.
<p>If you use the phpMyAdmin, Drop all formmakex tables before restore.
<hr>
