...
define('_MI_FORMMAKEX_MAILUSER_DESC', 'アンケート用メールアドレスのユーザー名を設定します');
define('_MI_FORMMAKEX_MAILPWD', 'メール・パスワード');
define('_MI_FORMMAKEX_MAILPWD_DESC', 'アンケート用メールアドレスのパスワードを設定します');
define('_MI_FORMMAKEX_MAILADDR', 'メール・アドレス');
define('_MI_FORMMAKEX_MAILADDR_DESC', 'アンケート用メールアドレスを設定します');
...
define('_MI_FORMMAKEX_UNSETGROUP', '設定除外グループ');
define('_MI_FORMMAKEX_UNSETGROUP_DESC', '|で区切って複数指定可能');
define('_MI_FORMMAKEX_SUBMITJUMPURI', '回答後ジャンプ先URI');
define('_MI_FORMMAKEX_SUBMITJUMPURI_DESC', 'アンケート回答後に統一したジャンプ先を指定したい場合に設定します');
define('_MI_FORMMAKEX_INVALIDJUMPURI', '無効ジャンプ先URI');
define('_MI_FORMMAKEX_INVALIDJUMPURI_DESC', '無効なフォームをリクエストした場合のジャンプ先を指定します');
