...
define('_MD_FORMMAKEX_DETAIL', '詳細');
...
define('_MD_FORMMAKEX_THANKS_ENTRY', 'アンケートへの記入ありがとうございました。');
define('_MD_FORMMAKEX_CAN_WRITE_USER_ONLY', 'ゲストユーザはアンケートを編集することはできません。');
define('_MD_FORMMAKEX_YOU_DONT_HAVE_A_PERMISSION', 'この機能を利用する権限がありません。');
...
define('_MD_FORMMAKEX_FORMATERR', ' は正しく入力されていません');
define('_MD_FORMMAKEX_DIGITERR', ' は半角で数字を入力してください');
define('_MD_FORMMAKEX_MAXOVER', 'は、%u項目以上チェックできません');
define('_MD_FORMMAKEX_CHECKANY', '（複数選択可）');
define('_MD_FORMMAKEX_CHECKLIMIT', '（%uつまで選択可）');
define('_MD_FORMMAKEX_CHECKRESET', '選択解除');
define('_MD_SUBMIT_FORM', '送信');
define('_MD_NEXT_PAGE', '次ページ');
define('_MD_FORMMAKEX_COPY_TITLE_PREFIX', 'コピー %s〜 ');
...
define('_AM_FORMMAKEX_MANAGE','アンケート管理');
define('_AM_FORMMAKEX_SEEARESULT','個別の回答を見る');
define('_AM_FORMMAKEX_COPYQUESTION','アンケートから質問をコピー');
define('_AM_FORMMAKEX_SELECTSTATUS','状態を選択');
define('_AM_FORMMAKEX_RATECOUNT','カウント表示');
define('_AM_FORMMAKEX_NORESPONSE','無回答');
define('_AM_FORMMAKEX_TOTAL','合計');
define('_AM_FORMMAKEX_QUESTIONNUMBER','設問<BR>番号');
define('_AM_FORMMAKEX_ARCHIVED','保管中');
define('_AM_FORMMAKEX_TEST','テスト');
define('_AM_FORMMAKEX_EXPIRATION','終了');
define('_AM_FORMMAKEX_ACTIVE','アクティブ');
define('_AM_FORMMAKEX_EDIT','編集');
define('_AM_FORMMAKEX_PURGE','破棄');
define('_AM_FORMMAKEX_VALUE','選択肢');
define('_AM_FORMMAKEX_COUNT','回答数');
define('_AM_FORMMAKEX_NA','無回答');
...
define("_MB_Sorry_please_fill_out_the_name","実行前に名前、グループ、タイトルの項目を埋めてください。");
...
define("_MB_Add_another_answer_line","回答項目の追加");
...
define("_MB_Username_are_required.","ユーザーネーム、パスワード、およびグループが必要です");
...
define("_MB_Click_on_a_username_to_edit","ユーザ名をクリックして編集するか、以下に新しいユーザー追加します。");
define("_MB_disabled","使用不可");
...
define("_MB_Form_not_specified","エラー：アンケートが選択されていません");
...
define("_MB_Request_failed,_please_choose_a_different_username","リクエスト失敗。違うユーザーを選択下さい。");
...
define('FORMMAKEX_INDEX_PAGETITLE', 'アンケート一覧');
...
define('FORMMAKEX_TABS_QUESTIONS_QUESTION_CONTENT', '質問文');
define('FORMMAKEX_TABS_QUESTIONS_FIELD_NUM', 'フィールド番号');
define('FORMMAKEX_TABS_QUESTIONS_FIELD_CONTROL', 'フィールド操作');
define('FORMMAKEX_TABS_QUESTIONS_QUESTION_INFOS', '質問の設定');
define('FORMMAKEX_TABS_QUESTIONS_CHOICES_INFOS', '選択肢の設定');
define('FORMMAKEX_TABS_QUESTIONS_CHOICES_DESC', '選択肢の最後に自由回答欄を作成するには !other を入れます');
define('FORMMAKEX_TABS_ORDER_COL_NAME_TYPE', 'フィールド名・フィールドタイプ');
define('FORMMAKEX_TABS_ORDER_COL_MOVE', '順序変更');
define('FORMMAKEX_TABS_ORDER_COL_EDIT', '編集');
define('FORMMAKEX_TABS_ORDER_COL_REMOVE', '削除');

define('FORMMAKEX_QTYPE_1','はい/いいえ');
define('FORMMAKEX_QTYPE_2','テキスト・ボックス');
define('FORMMAKEX_QTYPE_3','テキスト・エリア');
define('FORMMAKEX_QTYPE_4','単一項目の選択');
define('FORMMAKEX_QTYPE_5','複数項目の選択');
define('FORMMAKEX_QTYPE_6','ドロップダウン・リストから１つ選択');
define('FORMMAKEX_QTYPE_7','Rating');
define('FORMMAKEX_QTYPE_8','５段階評価から１つ選択');
define('FORMMAKEX_QTYPE_9','日付入力');
define('FORMMAKEX_QTYPE_10','数字入力');
define('FORMMAKEX_QTYPE_40','添付ファイル');
define('FORMMAKEX_QTYPE_99','改ページ');
define('FORMMAKEX_QTYPE_100','見出しタイトル');
