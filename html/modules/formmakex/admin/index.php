...
echo "<li><a href='".$url."doc_updateinfo.php'><span>"._AM_FORMMAKEX_DOC_UPDATEINFO."</span></a></li>";
echo "<p>";
echo "<li><a href='".$url."doc_popnupblog.php'><span>"._AM_FORMMAKEX_DOC_POPNUPBLOG."</span></a></li>";
echo "<p>";
echo "<li><a href='".$url."doc_mailto.php'><span>"._AM_FORMMAKEX_DOC_MAILTO."</span></a></li>";
echo '</div>';
...
function checkPermit(){
	...
	if ($dir = @opendir($modpath."/log/")) {
		while($file = readdir($dir)) {
			if($file == ".." || $file == "." || eregi("^\.(.*)",$file) || $file == "index.htm" ) continue;
	...
	foreach($_check_list as $dir){
		if(!is_writable($dir)){
			$permit_err[] = _AM_FORMMAKEX_ERROR01."=> ".$dir;
		}
	}
