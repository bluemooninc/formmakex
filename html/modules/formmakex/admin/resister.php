...
if(isset($_POST['send'])) {
	...
	if($Respondent['email']){
		...
		$xoopsMailer->setFromEmail(formmakexTable::getXoopsModuleConfig('MAILADDR'));
...
include 'adminmenu.php';
	...
	*/
	...
	echo "<tr><td class='head' colspan=2><b>"._AM_FORMMAKEX_INVITATION."</b></td></tr>";
	echo "<td class='odd' align='right'>"._AM_FORMMAKEX_EMAIL."</td><td class='even'>";
	echo "<input type='text' name=email value='' /></td>";
	echo "</tr><tr>";
	echo "<td class='odd' align='right'>"._AM_FORMMAKEX_SUBJECT."</td><td class='even'>";
	echo "<input type='text' name=subject value='M,NEW;"._AM_FORMMAKEX_SUBJECT_NEW."' /></td>";
	echo "</tr><tr>";
	echo "<tr><td class='odd' align='right'>"._AM_FORMMAKEX_MESSAGE."</td><td class='even'>";
 	echo "<textarea name='message' rows=6 cols=40>"._AM_FORMMAKEX_MESSAGE_NEW."</textarea></td>";
	echo "</tr><tr>";
