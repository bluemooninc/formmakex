...
function mkresratecount($counts,$total,$precision,$showTotals,$length,$fullcount,$th_title) {
	...
	echo "<caption><b><font size=+1>"._AM_FORMMAKEX_RATECOUNT."</font></b></caption>";
	echo "<tr bgcolor=".$bg.">";
	...
	echo "<td align='center' width='$width'>"._AM_FORMMAKEX_NORESPONSE
		."</td><td align='center' width='$width'>"._AM_FORMMAKEX_TOTAL."</td></tr>";
    $bg = '';
    $noresSum = 0;
    $vcount = "A";
	...
	echo "<tr><td align='right'>"._AM_FORMMAKEX_TOTAL."</td>";
	$rsum=0;
	for ($i = 0; $i < $length; $i++){
