<?php
$xoopsOption['template_main'] = 'formmakex_manage.html';
$tpl_vars = array('content' => array(), 'langs' => array(), 'config' => array());
$tpl_vars['content']['forms'] = formmakexTable::get_form_list(0,true,'changed','DESC',false);
$tpl_vars['langs'] = array(
	'form_title' => _MB_LIST_TITLE,
	'form_subtitle' => _MB_LIST_SUBTITLE,
	'form_username' => _MB_LIST_UNAME,
