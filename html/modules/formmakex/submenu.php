...
foreach($_SESSION['formmakex'] as $key => $val) {	// Spread a SESSION value.
...
******************************************************************************/
// Usage :
//   'cid' : It is ID of the item selected by the multi choice. Please retrieve the corresponding section by the source of the former divergence questionnaire or retrieve it from the formmakex_question_choice table. 
//           Ex><input type="checkbox" name="Q142[]" value="384" />question strings.... This mean qid=142 cid=384.
//   'sid' : It is form ID. It specifies it by the number of left ends of the list of the form management. In the table, it is possible to retrieve it from formmakex_form.
